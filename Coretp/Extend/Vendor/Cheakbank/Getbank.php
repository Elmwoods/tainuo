...
class GetBank{    
        ...
        623251, 628351, 627066,627067,627068,627069,412962,412963,415752,415753,622535,622536,622538,622539,622983,998800,623668,955998);  
    // "发卡行.卡种名称",    
    public static $bankName = array(   
     ...
     "玉溪市商业银行·红塔卡" ,"平安银行","平安银行","平安银行","平安银行","平安银行","平安银行","平安银行","平安银行","平安银行","平安银行","平安银行","平安银行","平安银行","平安银行","中国建设银行·结算通卡","农业银行·借记卡");  
            ...
            public function getname($cardnumber) {    
                ...
                if(!array_search($charBin, self::$bankBin)) $index=-1;
