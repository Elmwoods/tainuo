...
<!-- 新窗口的选项卡结束 -->
    <div class="tit">
        <div class="icontithome">城市管理</div>
    ...
    <tbody><tr class="theader">
	  ...
	  <volist name="arr" id="vol">
		 ...
		 <input type="hidden" value="<{$vol.id}>" name="id[]"></td>
		  <td><a href="<{:C('web_url')}>__APP__/country_xian.html?parent_id=<{$vol.id}>">查看市区</a></td>
		 <td align="center">
		  		<a onclick="javascript:return confirm('确定要删除吗?')" href="<{:C('web_url')}>__APP__/country_city.html?act=del&id=<{$vol.id}>"><img src="<{:C('web_url')}>__WJ__/images/delete.png"></a>  </td>
        </tr>
		 </volist>
		  ...
		  <td align="left">&nbsp;</td>
            ...
            <tr>
			  <td align="left" style="padding-left:40px;" colspan="7">
