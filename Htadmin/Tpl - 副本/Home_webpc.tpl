...
<!-- 新窗口的选项卡结束 -->
    <div class="tit">
        <div class="icontithome">PC网站信息</div>
  ...
  <tr>
    <th width="13%">网站标题：</th>
    <td width="87%"><input name="title" type="text" id="title" class="cd500"  value="<{$show.title}>"/></td>
  </tr>
  <tr>
    <th width="13%">网站关键字：</th>
    <td width="87%"><input name="key" type="text" id="key" class="cd500"  value="<{$show.key}>"/></td>
  </tr>
  <tr>
    <th width="13%">网站描述：</th>
    <td width="87%"><textarea name="des" rows="10" class="cd" id="des" style="width:500px; height:100px;"><{$show.des}></textarea></td>
  </tr>
    <tr>
    <th>&nbsp;</th>
    <td>*请上传大小为166px × 80px的图片 500K以内</td>
  </tr>
  <tr>
    <th>LOGO图片：</th>
  ...
  <tr>
    ...
    <td width="87%"><input name="KUAIDI_APP_KEY" type="text" id="KUAIDI_APP_KEY" class="cd200"  value="<{$show.KUAIDI_APP_KEY}>"/>需要到 [http://www.kuaidi100.com] 申请APP_KEY</td>
  </tr>
  <tr>
