...
<!--map-->
<script type="text/javascript" src="<{$Think.config.web_url}>__WJ__/js/jquery-1.3.1.js"></script>
<script type="text/javascript" src="<{$Think.config.web_url}>__WJ__/js/highcharts.js" ></script>

</head>
<body>
<!-- 新窗口的选项卡结束 -->
    <div class="tit">
        <div class="icontithome">订单报表统计</div>
	...
	<div class="textinfo">
	<div style="text-align:center; font-size:14px; margin-bottom:20px;"><form action="" method="get"><strong>时间段查询</strong>：<input name="ks" type="text" id="ks" class="cd150"  value="<{$ks}>" onClick="WdatePicker({doubleCalendar:true,dateFmt:'yyyy-MM-dd',minDate:'{%y-50}-%M-{%d+0}',maxDate:'%y-{%M}-{%d-1}'})" readonly/>--<input name="js" type="text" id="js" class="cd150"  value="<{$js}>" onClick="WdatePicker({doubleCalendar:true,dateFmt:'yyyy-MM-dd',minDate:'{%y-50}-%M-{%d+0}',maxDate:'%y-{%M}-{%d}'})" readonly/>&nbsp;<input type="submit" value="统计查看" class="btn btn-primary" /></form></div>
