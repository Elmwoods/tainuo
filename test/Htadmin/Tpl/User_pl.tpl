...
function addinfo(act,ids) {
               if (ids == null || ids ==''){
               parent.MsgBox.OpenWin({ id: 'MenuEdit', title: '添加评论', width: 1000, height: 600, url: urlS+'user_pld.html?act='+act});
			   }
			   else
			   {
			    parent.MsgBox.OpenWin({ id: 'MenuEdit', title: '查看评论', width: 1000, height: 600, url: urlS+'user_pld.html?act='+act+'&id='+ids});
			   }
        }
		</script>
</head>
...
<!-- 新窗口的选项卡结束 -->
    <div class="tit">
        <div class="icontithome">酒讯评论管理</div>
...
<div class="search"><form id="searchform" action="" method="get"><span>会员账户/酒讯标题/内容：</span><span><input name="title" type="text" class="cd" value="<{$title}>"/>&nbsp;</span>
<span>
	...
	<table width="100%" class="table table-bordered table-hover">
				<tr>
			      ...
			      <tr>
						...
						<span>[<a href="<{:C('web_url')}>__APP__/user_pl.html?id=<{$vo.id}>" onClick="return ConfirmDel();">删除</a>]</span></td>
				  </tr>
				  </volist>
		</table>
	  </form>	     
