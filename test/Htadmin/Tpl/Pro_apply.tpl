...
<td><{$vo.id}></td>	-->
                                ...
                                <td>
                                    <span>[<a href="<{:C('web_url')}>__APP__/pro_apply.html?iid=<{$vo.id}>"  onClick="return apply();">审核通过</a>]</span>&nbsp;
                                    <span>[<a href="<{:C('web_url')}>__APP__/pro_apply.html?id=<{$vo.id}>"  onClick="return ConfirmDel();">删除</a>]</span>&nbsp;
                                </td>
                            </tr>				  
                        </volist>
                    </table>
		...
		<script>
		function sp(){
		 $("#nodecatEditor").attr("action","<{:C('web_url')}>__APP__/pro_applysp.html");
