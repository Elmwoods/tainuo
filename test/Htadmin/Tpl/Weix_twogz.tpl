...
<!-- 新窗口的选项卡结束 -->
    <div class="tit">
        <div class="icontithome">消息自动回复</div>
		<div class="fh"><a class="btn" href="Javascript:window.history.go(-1)">返回</a></div>
    </div>
	
	<div class="mainbox topborder">
	<div class="contentbox">
	<form  method="post" action="<{:C('web_url')}>__APP__/weix_twogz" id="myformly" name="myformly"><input name="id" type="hidden" value="<{$show.id}>" />
	...
	<tr>
    <th width="13%"></th>
    <td width="87%"><div class="messg">当客户向公众账号发送消息时，没有找到关键字将自动回复此消息。。 </div></td>
  </tr>
    <tr>
      <th colspan="2">
	  <div class="replyList">
