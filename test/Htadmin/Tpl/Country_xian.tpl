...
<!-- 新窗口的选项卡结束 -->
    <div class="tit">
        <div class="icontithome">市区管理</div>
		<div class="fh"><a class="btn" href="<{$Think.cookie.fh|default='Javascript:window.history.go(-1)'}>">返回城市</a></div>
    </div>
...
<form style="margin-top:0px;" method="POST" action="" id="form1">
  <table class="table table-bordered" width="100%">
    <tbody><tr class="theader">
      ...
      <td width="143" align="left">城市</td>
      <td width="313" align="left">英文名称</td>
	  ...
	  <volist name="arr" id="vol">
		 ...
		 <td align="center">
		  		<a onclick="javascript:return confirm('确定要删除吗?')" href="<{:C('web_url')}>__APP__/country_xian.html?act=del&id=<{$vol.id}>"><img src="<{:C('web_url')}>__WJ__/images/delete.png"></a>  </td>
        </tr>
		 </volist>
