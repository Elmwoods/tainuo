        ...
        <div class="login">
            <div class="login_text">
                ...
                <div class="login_txt">
                    <p>
                        <em>项目名称：</em>
                        <input type="text" name="title" value='<?php echo ($subject["title"]); ?>'  id="title" placeholder="项目名称"/>
                    </p>
                    <p>
                        <em>选择酒店：</em>
                        <select name="hotel_id" id="hotel_id" style="width:47%;margin-right: 5%;display: inline-block;" class="select">
                            <option value="0">选择酒店</option>
                            <?php if(is_array($hotel)): foreach($hotel as $key=>$v): ?><option <?php if($v['id'] == $subject['hotel_id']): ?>selected<?php endif; ?> value="<?php echo ($v["id"]); ?>"><?php echo ($v["title"]); ?></option><?php endforeach; endif; ?>
                        </select>
                    ...
                    <p>
                        <em>工作日期：</em>
                        <input type="text" readonly name="worktime" value="<?php echo ($subject["worktime"]); ?>"  data-field="date" id="day"  placeholder="工作日期"/>
                    </p>
                    <p>
                        <em>下单人数：</em>
                        <input type="text" name="num" id="num" value="<?php echo ($subject["num"]); ?>" placeholder="下单人数"/>
                    </p>
                    <p>
                        <em>现场人数（当前项目已有<?php echo ($sl); ?>人）：</em>
                        <input type="text" name="total" id="total" value="<?php echo ($subject["total"]); ?>" placeholder="现场人数"/>
                    </p>
                    <p>
                        <em>选择服务员：</em>
...
<script>
    ...
    obj.loadMore({
        ...
        $('body').append(load);
        $.ajax({
            url: "<?php echo U('foremen/changeitem');?>",
            type: 'get',
            data: {
                page: i,
                isflag: true,
    ...
    $(function () {
        ...
        $('#hotel_id').change(function () {
            var hotel_id = $('#hotel_id').val();
            var part_id = '<?php echo ($subject["part_id"]); ?>';
            $.ajax({
