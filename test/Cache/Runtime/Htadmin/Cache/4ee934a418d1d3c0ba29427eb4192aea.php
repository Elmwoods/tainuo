...
/* top */
.top{ width:100%; height:78px; background:url(<?php echo C('web_url');?>__WJ__/images/top_bg1.jpg) repeat-x left top; text-align:left;}
.main_bg1{ position:absolute; left:50%; top:50%; margin-left:-384px; margin-top:-230px; width:767px; height:460px; background:url(<?php echo C('web_url');?>__WJ__/images/main_bg2.jpg) no-repeat; text-align:left;}
...
.main .main_lf .main_lf_inter{ width:260px; margin-top:35px; height:40px; line-height:40px; background:url(<?php echo C('web_url');?>__WJ__/images/login_bg1.jpg) repeat-x; text-align:center; font-family:"微软雅黑"; font-size:18px;}
.main .main_lf .main_lf_inter a{ display:block; width:100%; height:100%; color:#1e92cb; border:#ccc 1px solid;}
.main .main_lf .main_lf_inter a:hover{ background:url(<?php echo C('web_url');?>__WJ__/images/login_bg2.jpg) repeat-x; border:#046ba3 1px solid; color:#fff;}
...
.main .main_rg .main_input_bg1{ width:246px; height:35px; line-height:35px; background:url(<?php echo C('web_url');?>__WJ__/images/input_bg3.jpg) no-repeat; text-indent:50px; float:left;}
.main .main_rg .main_input_bg2{ width:246px; height:35px; line-height:35px; background:url(<?php echo C('web_url');?>__WJ__/images/input_bg1.jpg) no-repeat; text-indent:50px;float:left;}
.main .main_rg .main_input_bg3{ width:86px; height:35px; line-height:35px; margin-right:8px; background:url(<?php echo C('web_url');?>__WJ__/images/input_bg4.jpg) no-repeat; padding-left:50px;}
.main .main_rg  .main_rg_btn1{ list-style:none;}
.main .main_rg  .main_rg_btn1 li{ float:left; height:32px;margin-right:10px;}
.main .main_rg  .main_rg_btn1 li a{ display:block; padding:0 20px; line-height:32px; background:url(<?php echo C('web_url');?>__WJ__/images/btn_bg2.jpg) repeat-x; border:#ccc 1px solid;}
.main .main_rg  .main_rg_btn1 li a:hover{ background:url(<?php echo C('web_url');?>__WJ__/images/btn_bg3.jpg) repeat-x; border:#0e87c1 1px solid; color:#fff;}
...
<script src="<?php echo C('web_url');?>__WJ__/js/jquery-1.9.1.min.js"></script>
<script src="<?php echo C('web_url');?>__WJ__/js/function.js"></script>
</head>
<body>
<!-- top -->
<div class="top">
	<div><img src="<?php echo C('web_url');?>__WJ__/images/logo2.jpg" alt="<?php echo (L("lg_web")); ?>" width="332" height="70" /></div>    
</div>
<!-- main -->
<div class="main_bg1">    
    <div class="main">
        ...
        <div class="main_lf">
        	<p><img src="<?php echo C('web_url');?>__WJ__/images/login_3.png" alt="login" width="180" height="48" /></p>
            <br />
            <br />
            <p><img src="<?php echo C('web_url');?>__WJ__/images/btn_3.png" alt="管理系统" width="180" height="127" /></p>            
        </div>
        <div class="main_rg">
        	<form action="" method="post" name="login" id="login">
            	<table width="310" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="250" align="left"><input name="username" type="text" class="main_input_bg1" id="username" maxlength="20" autocomplete="off" value="<?php echo ($htadmin); ?>" /></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td height="45" align="left"><input name="code" type="text" class="main_input_bg3" id="code" maxlength="6" autocomplete="off" /><img src='<?php echo C('web_url');?>__APP__/pub_verify.html' onclick="this.src=this.src+'?'+Math.random();"/>
</td>
                  </tr>
                  <tr>
