    ...
    <body>
        ...
        <div class="mainbox topborder">
            ...
            <div class="search"><form id="searchform" action="" method="get"><span>项目名称：</span><span><input name="title" type="text" class="cd" value="<?php echo ($title); ?>"/>&nbsp;</span>
                ...
                <span>总返利：<?php echo (($rebate)?($rebate):0); ?>元&nbsp;&nbsp;&nbsp;</span><span>总薪酬：<?php echo (($reward)?($reward):0); ?>元&nbsp;&nbsp;&nbsp;</span>
                <span>总工时：<?php echo (($hours)?($hours):0); ?>小时&nbsp;&nbsp;&nbsp;</span><span>总下单人数：<?php echo (($xd_sum)?($xd_sum):0); ?>人&nbsp;&nbsp;&nbsp;</span>
                <span>总考勤人数：<?php echo (($kq_sum)?($kq_sum):0); ?>人&nbsp;&nbsp;&nbsp;</span>
            </div>
            <div class="clear"></div>
            <!--内容-->
...
<td><?php echo ($vo["id"]); ?></td>						-->
                                ...
                                <td><?php echo (($vo["rebate"])?($vo["rebate"]):0); ?></td>
                                <td><?php echo (($vo["hours"])?($vo["hours"]):0); ?></td>
                                <!--<td><?php echo (($vo["wage"])?($vo["wage"]):0); ?></td>-->
                                <td><?php echo (($vo["reward"])?($vo["reward"]):0); ?></td>
                                <td><?php echo sumprice('item','subject_id',$vo['id'],'send_price');?></td>
                                
                                <td><?php echo (($vo["num"])?($vo["num"]):0); ?></td>
                                <td><?php echo (($vo["kq_num"])?($vo["kq_num"]):0); ?></td>

                                <td><?php echo date('Y-m-d H:i:s',$vo['addtime']);?></td>
                                <td>
                                    <span>[<a href="<?php echo C('web_url');?>__APP__/pro_sublist.html?id=<?php echo ($vo["id"]); ?>">详情</a>]</span>&nbsp;
                                    <!--<span>[<a href="<?php echo C('web_url');?>__APP__/pro_subject.html?id=<?php echo ($vo["id"]); ?>"  onClick="return ConfirmDel();">删除</a>]</span>&nbsp;-->
                                </td>
