  ...
  <input type="submit" value="搜索" class="btn btn-primary"/></form>
	...
	<table width="100%" class="table table-bordered">
                ...
                <?php if(is_array($show)): $i = 0; $__LIST__ = $show;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td>
                        <span onclick="addinfo('<?php echo ($vo["id"]); ?>');">[<a href="javascript://">修改</a>]</span>&nbsp;
                        <span>[<a href="<?php echo C('web_url');?>__APP__/user_level.html?id=<?php echo ($vo["id"]); ?>" onClick="return ConfirmDel();">删除</a>]</span>
                        </td>
