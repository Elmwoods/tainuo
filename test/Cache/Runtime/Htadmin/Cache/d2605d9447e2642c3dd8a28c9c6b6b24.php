...
<script type="text/javascript" src="<?php echo C('web_url');?>__WJ__/js/msg/json2.js"></script>
    ...
    <body>
        <!-- 新窗口的选项卡结束 -->
        <div class="tit">
            <div class="icontithome">项目详情-<?php echo ($subject["title"]); ?></div>
        ...
        <div class="mainbox topborder">
            ...
            <div class="control-group" style="padding-top:6px;">
                ...
                <input type="button" value="将当前条件下数据导出为Excel" class="btn btn-primary btn-sm" onclick="location.href = '<?php echo C('web_url');?>__APP__/pro_xqdc';">

            </div>
        <!--<div class="search"><form id="searchform" action="" method="get"><span>标题：</span><span><input name="title" type="text" class="cd" value="<?php echo ($title); ?>"/>&nbsp;</span>
          <span>发布人：</span><span><input name="user" type="text" class="cd" value="<?php echo ($username); ?>"/>&nbsp;</span>
                ...
                <form id="nodecatEditor" name="nodecatEditor" method="post" action="">
                    <table width="100%" class="table table-bordered">
                        ...
                        <?php if(is_array($arr)): $i = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                ...
                                <td><?php echo ($vo["break"]); ?></td>
                                <td><?php echo ($vo["hours"]); ?></td>
                                <td><?php echo ($vo["wage"]); ?></td>
                                <td><?php echo ($vo["reward"]); ?></td>
                                <td><?php echo ($vo["rebate"]); ?></td>
                                <td><?php if($vo['clothes'] ==1): ?>是<?php else: ?>否<?php endif; ?></td>
                                <td><?php if($vo['pay'] ==1): ?>是<?php else: ?>否<?php endif; ?></td>
