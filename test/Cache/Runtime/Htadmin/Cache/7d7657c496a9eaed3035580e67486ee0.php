    ...
    <body>
        ...
        <div class="mainbox topborder">
            ...
            <div class="search"><form id="searchform" action="" method="get">
                    ...
                    <span>总薪酬：<?php echo ($tj["rewards"]); ?>元&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> <span>总工时：<?php echo ($tj["hourss"]); ?>小时&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> <span>总返利：<?php echo ($tj["rebates"]); ?>元</span>
            </div>
            <div class="clear"></div>
            <!--内容-->
...
<td><?php echo ($vo["id"]); ?></td>						-->
                                ...
                                <td><?php echo ($vo["hourss"]); ?>小时</td>
                                <td><?php echo ($vo["rebates"]); ?>元</td>
                                <td><?php echo ($vo["rewards"]); ?>元</td>
                                <td>
                                    <span>[<a href="<?php echo C('web_url');?>__APP__/pro_fitem.html?id=<?php echo ($vo["user_id"]); ?>" >详情</a>]</span>
                                </td>
